...
ALTER TABLE SEDES.KONTAKTKONTAKTEN
  ADD CONSTRAINT UK_KKO_KONTAKTKONTAKT FOREIGN KEY (PARENTKONTAKT) UNIQUE (PARENTKONTAKT, CHILDKONTAKT, STARTDATUM);
