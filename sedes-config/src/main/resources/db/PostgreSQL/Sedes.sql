...
CREATE TABLE SEDES.WERELDDELEN (
  WERELDDEEL_ID                   INTEGER         NOT NULL  GENERATED BY DEFAULT AS IDENTITY,
...
ALTER TABLE SEDES.KONTAKTADRESSEN
  ADD CONSTRAINT UK_KAD_PER_KONTAKTADRESTYPE UNIQUE (KONTAKTADRESTYPE, ADRES_ID, KONTAKT_ID, STARTDATUM);
...
INSERT INTO SEDES.WERELDDEELNAMEN
 VALUES ('Aarde', 'nl', 1);

INSERT INTO SEDES.MUNTEN
        (BESTAAT, DECIMALEN, ISO3, MUNTTEKEN, NAAM, SUBEENHEID)
 VALUES ('N', 2, '???', '-', 'onbekend', NULL);
